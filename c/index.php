<?php 
  ...
  $title = 'words';
  $image = 'https://jsbot.cantelope.org/1pnBdc.png';
  if(isset($_GET['i']) && $query[1] === 'post'){
    ...
    $image = 'https://jsbot.cantelope.org/1GY3GM.png';
  }
...
?> <!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=1024"><title><?php echo $title?></title> <?php  if($image){?> <link rel="icon" href="<?php echo 'https://code.cantelope.org/a/imgProxy.php?url='.$image?>"><?php }else{?> <link rel="icon" href="https://jsbot.cantelope.org/1GY3GM.png"> <?php }?> <?php  if($image){?><meta property="og:url" content="<?php echo $url?>"><?php }?> <?php  if($image){?><meta property="og:type" content="<?php echo $type?>"><?php }?> <?php  if($image){?><meta property="og:title" content="<?php echo $title?>"><?php }?> <?php  if($image){?><meta property="og:description" content="<?php echo $description?>"><?php }?> <?php  if($image){?><meta property="og:image" content="<?php echo $image?>"><?php }?> <?php  if($image){?><meta property="og:image:secure_url" content="<?php echo 'https://code.cantelope.org/a/imgProxy.php?url='.$image?>"><?php }?> <link href="css/app.f2e0b410.css" rel="preload" as="style"><link href="js/app.1f30cbfa.js" rel="preload" as="script"><link href="js/chunk-vendors.f6efeced.js" rel="preload" as="script"><link href="css/app.f2e0b410.css" rel="stylesheet"></head><body><noscript><strong>We're sorry but words.whitehotrobot.com doesn't work properly without JavaScript enabled. Please enable it to continue.</strong></noscript><div id="app"></div><script src="js/chunk-vendors.f6efeced.js"></script><script src="js/app.1f30cbfa.js"></script></body></html>